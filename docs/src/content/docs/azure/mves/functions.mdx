---
title: Functions
description: This guide shows you how to work with Azure Functions using Python and Azure Functions Core Tools. This lab demonstrates how to develop, run, debug, test, and validate an HTTP-triggered function locally.
isLab: true
---
