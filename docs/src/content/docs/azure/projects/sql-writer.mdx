---
title: SQL Writer
description: "Run Azure SQL Database locally with Azure Functions and SQLAlchemy: process HTTP POST requests and persist data into a SQL database."
isLab: true
---
...
- [See the AWS equivalent project.](/aws/projects/sql-writer/)
- [Dive into the Azure Functions Lab.](/azure/mves/functions/)
