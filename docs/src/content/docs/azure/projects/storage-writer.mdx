...
description: "Run Azure Functions locally with Azurite and Docker Compose: an HTTP-triggered Python function that uploads files to blob storage."
isLab: true
---
...
- [See the AWS equivalent project.](/aws/projects/storage-writer/)
...
- [Dive into the Blob Storage Lab.](/azure/mves/blob-storage/)
