---
title: NoSQL Writer
description: This guide shows you how to work with Google Cloud Run and Firestore locally using the Firebase Emulator Suite and Python. This lab demonstrates how to create a containerized service that registers patients in Firestore.
isLab: true
---
