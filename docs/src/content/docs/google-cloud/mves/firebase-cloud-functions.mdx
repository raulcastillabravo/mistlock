...
description: This guide shows you how to work with Google Cloud Firebase Functions locally using the Firebase Emulator Suite. This lab demonstrates a synchronous HTTPS function that retrieves a secret from Secret Manager based on user name.
isLab: true
---
