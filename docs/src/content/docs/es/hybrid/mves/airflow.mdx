---
title: Airflow
description: "Ejecuta Apache Airflow en local con Docker: un pipeline ETL sencillo con tareas de extracción, transformación y carga como un DAG programado."
isLab: true
---
...
- [Explora el Lab relacionado Simple ETL (GCP).](/es/google-cloud/projects/simple-etl/)
