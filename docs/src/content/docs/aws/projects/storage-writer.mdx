...
description: Build an AWS Lambda function that uploads files to S3 locally with LocalStack, deployable via Terraform, CloudFormation, or Boto3.
isLab: true
---
...
- [See the Google Cloud equivalent project.](/google-cloud/projects/storage-writer/)
