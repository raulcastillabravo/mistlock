---
title: SQL Writer
description: "Build a hybrid cloud scenario with LocalStack: an AWS Lambda retrieves secrets from Secrets Manager and writes to an external PostgreSQL database."
isLab: true
---
...
- [See the Azure equivalent project.](/azure/projects/sql-writer/)
- [Dive into the Lambda (SAM) Lab.](/aws/mves/lambda-sam/)
- [Dive into the RDS Postgres Lab.](/aws/mves/rds-postgres/)
