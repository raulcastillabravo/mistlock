---
title: Simple ETL
description: This guide shows you how to build a file processing pipeline using AWS S3, Lambda, and DynamoDB locally with LocalStack. This lab demonstrates how S3 uploads trigger a Lambda to log metadata into a DynamoDB table.
isLab: true
---
...
:::caution[Switching deployment methods]
