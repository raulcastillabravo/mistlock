---
title: Lambda (SAM)
description: Run AWS Lambda locally with the Serverless Application Model (SAM) and Python, building a local API Gateway and invoking functions with the SDK.
isLab: true
---
...
- [Build on this MVE with the SQL Writer project.](/aws/projects/sql-writer/)
- [Build on this MVE with the Simple ETL project.](/aws/projects/simple-etl/)
