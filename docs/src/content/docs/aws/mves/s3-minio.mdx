---
title: S3 MinIO
description: This guide shows you how to work with AWS S3 locally using MinIO and Python. This lab demonstrates how to integrate S3 libraries (Boto3, PyArrow, and Deltalake) for local data pipelines and object storage emulation.
isLab: true
---
...
2. **Run the Example**:
   <Tabs>
      ...
      <TabItem label="AWS CLI">
         Upload the README file to the bronze bucket:
         ```bash
