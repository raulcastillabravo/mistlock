---
title: Mongo
description: This guide shows you how to work with MongoDB locally using Docker Compose, MongoEngine, and Python. This lab demonstrates basic CRUD operations using different execution and validation tools.
isLab: true
---
