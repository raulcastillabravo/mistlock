...
description: This guide shows you how to work with Dev Containers using Docker and VS Code. This lab demonstrates the key concepts and components of Dev Containers through a simple Python application.
isLab: true
---
