---
title: RabbitMQ
description: "Run RabbitMQ locally with Docker Compose and Python: real-time event publishing and consumption with the pika client."
isLab: true
---
...
- [Explore the related Redis Lab.](/hybrid/mves/redis/)
