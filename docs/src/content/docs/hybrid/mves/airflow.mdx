---
title: Airflow
description: This guide shows you how to work with Apache Airflow locally using Docker. This lab demonstrates a simple ETL pipeline with extract, transform, and load tasks running as a scheduled DAG.
isLab: true
---
